...
f = open('hs_eppugnn-id_map_inv.json')
id_map = json.load(f)
...
for ii in range(1, 5):
    for model in models:
        path_txt = './runs/' + str(ii) + '_/unsup-example_data/' + model + '_small_0.000010/val.txt'
        path_npy = './runs/' + str(ii) + '_/unsup-example_data/' + model + '_small_0.000010/val.npy'
        ...
        if os.path.isfile(path_txt) and os.path.isfile(path_npy):
            ...
            with open(path_txt, 'r') as val_txt:
                with open ('./runs/' + str(ii) + '_/unsup-example_data/' + model + '_small_0.000010/emb_out.csv', 'w+') as emb_csv:
            ...
            with open(path_txt, 'r') as val_txt:
                with open ('./runs/' + str(ii) + '_/unsup-example_data/' + model + '_small_0.000010/emb.csv', 'w+') as emb_csv:
